 ...
 * no description
 */
export class ResponsesApiRequestFactory extends BaseAPIRequestFactory {

    /**
     * Get Responses
     */
    public async getResponses(_options?: Configuration): Promise<RequestContext> {
...
export class ResponsesApiResponseProcessor {
